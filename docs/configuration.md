...
**How it works:**
- Failed events are automatically queued and retried every 30s with exponential backoff
- Up to 20 retry attempts before marking as failed
- Zero data loss during API downtime or network issues
